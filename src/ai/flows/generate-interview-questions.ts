...
const generateInterviewQuestionsPrompt = ai.definePrompt({
  ...
  prompt: `You are an expert interviewer. Generate a list of relevant and challenging interview questions for a candidate applying for the position of {{jobPosition}}. Consider the candidate's CV content when generating the questions.\n\nCV Content: {{{cvContent}}}\n\nQuestions:`, // Changed prompt to a single line with backticks
});
